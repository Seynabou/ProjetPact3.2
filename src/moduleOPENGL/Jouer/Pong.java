...
//il faudrait voir pourquoi ça bug lorsque l'on implemente les methodes de l'interface reliant GUI et Affichage
...
//	}
	...
	public void init()
	{
		...
		Display.setTitle("Mental Pong par Pact des Loups");
		...
		//        	if (choixRaquette==1) variable1 = "src/ImagesGUI/raquetteSport";// u gotta  update this 
		...
		// Load textures
		ballTex = Texture.loadTexture("resources/ball.png");
		paddleTex = Texture.loadTexture("resources/paddle4.png");
		paddle2Tex = Texture.loadTexture("resources/paddle5.png");
		...
		Texture backTex = Texture.loadTexture("resources/back.png");
		backTex.width = 800;
		backTex.height = 600;
