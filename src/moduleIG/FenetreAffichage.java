...
public class FenetreAffichage {
	...
	public void show() {
		...
		// les deux lignes suivantes font parties de l'int�gration du
		// syst�me permettant la reproduction d'une execution
	...
	protected void setIcon(JButton button, String iconPath) {
		...
		// Dimensionne le bouton selon la taille de l'ic�ne.
		button.setPreferredSize(new Dimension(icon.getIconWidth(), icon
				.getIconHeight()));
		// Habille le bouton de l'ic�ne.
		button.setIcon(icon);
	}
	...
	public void addComponentsToPane(Container pane) {
		...
		buttonFacile.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				manitou.setSpeed(1);
				message = message + "Speed envoy�e : 1(FACILE)\n";
		...
		buttonNormal.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				manitou.setSpeed(2);
				message = message + "Speed envoy�e : 2(NORMAL)\n";
				// ReproduireExec.ecrire(chemin, message);
			};
		});
		...
		buttonDifficile.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				manitou.setSpeed(3);
				message = message + "Speed envoy�e : 1(DIFFICILE)\n";
				// ReproduireExec.ecrire(chemin, message);
			};
		});
		...
		buttonExpert.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				manitou.setSpeed(4);
				message = message + "Speed envoy�e : 4(EXPERT)\n";
				// ReproduireExec.ecrire(chemin, message);
			};
		});
	...
	public void addComponentsToPane2(Container pane) {
		...
		buttonFacile.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				manitou.setMode(1);
				message = message + "Mode envoy� : 1(J1vsJ2)\n";
				// ReproduireExec.ecrire(chemin, message);
			}
		});
		...
		buttonNormal.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				message = message + "Mode envoy� : 2(J1vsIA)\n";
				// ReproduireExec.ecrire(chemin, message);
			}
		});
		pane.add(buttonNormal, BorderLayout.CENTER);
		...
		buttonDifficile.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				message = message + "Mode envoy� : 3(J1&J2vsIA)\n";
				// ReproduireExec.ecrire(chemin, message);
			}
		});
		pane.add(buttonDifficile, BorderLayout.LINE_START);
	...
	public void addComponentsToPane3(Container pane) {
		...
		buttonFirst.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				// ce n'est pas au controleur qu'il faut donner la d�co mais
				// � affichage
				// manitou.setDeco(1);
				System.out.println("déco 1");
...
//				ecran.setDeco(1);
				...
				message = message + "Deco envoy�e: 1 \n";
				// ReproduireExec.ecrire(chemin, message);
...
//				ecran.setDeco(3);
		...
		buttonFourth.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				// manitou.setDeco(4);
				System.out.println("déco 4");
				
				//a enlever
//				ecran.setDeco(4);
				deco = 4;
				message = message + "Deco envoy�e: 4 \n";
				// ReproduireExec.ecrire(chemin, message);
...
//				ecran.setRaquette(1);
				...
				message = message + "Raquette envoy�e: 1 \n";
				// ReproduireExec.ecrire(chemin, message);
...
//				ecran.setRaquette(2);
				raquette = 2;
				message = message + "Raquette envoy�e: 2 \n";
				ReproduireExec.ecrire(chemin, message);
		...
		buttonThird.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				//ecran.setRaquette(3);
				raquette = 3;
				message = message + "Raquette envoy�e: 3 \n";
				// ReproduireExec.ecrire(chemin, message);
...
//				ecran.setRaquette(4);
				...
				message = message + "Raquette envoy�e: 4 \n";
				// ReproduireExec.ecrire(chemin, message);
