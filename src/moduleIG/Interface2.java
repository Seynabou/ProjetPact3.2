...
public class Interface2 extends JPanel {
	...
	public Interface2(Manitou manitou){	
	...
	public Interface2() {
		...
		super(new GridLayout(1, 1));  //comment faire pour que cela ne s'applique que sur le premier onglet?
	...
	public void show(){
		...
		frame.add(new Interface2(), BorderLayout.CENTER);									////////
	...
	public void panelMode(final JComponent panel1){
		...
		// go to step decor
		JButton buttonGoToStep = new JButton();
		String step4Path = "src/ImagesGUI/step4.jpg";
		setIcon(buttonGoToStep, step4Path);

		buttonGoToStep.addMouseListener(new MouseAdapter() {
	...
	public void panelDecor(JComponent panel2){
		...
		buttonGoToStep.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e){
				...
				panelRaquette(panel3);
				//fenetre.repaint();
				//fenetre.pack();
			}
		});
		panel2.add(buttonGoToStep);
	...
	public void panelRaquette(JComponent panel3){
